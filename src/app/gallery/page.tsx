...
// A more detailed interface for type safety
...
// Separated data fetching function for clarity
        ...
        {images.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {images.map((item) => {
              const id = item._id;
              const caption =
                item.caption ?? "Anjadhey Foundation Gallery Image";
              ...
              // Get the low-quality image placeholder for the blur effect
